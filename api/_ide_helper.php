...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \Packages\Infrastructure\Eloquent\User\User|null
         * @static
         */
         ...
         *
         * @param  mixed                                             $id
         * @return \Packages\Infrastructure\Eloquent\User\User|false
         * @static
         */
         ...
         *
         * @return \Packages\Infrastructure\Eloquent\User\User
         * @static
         */
...
namespace Rorecek\Ulid\Facades {
    ...
    class Ulid {
        ...
        public static function generate() {
            /** @var \Rorecek\Ulid\Ulid $instance */
...
namespace  {
    ...
    class Ulid extends \Rorecek\Ulid\Facades\Ulid {
    }
